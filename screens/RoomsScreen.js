    ...
    <>
      <ScrollView>
        ...
        >
          ...
          <Text style={{margin:3, color:"green"}}>Cancellation available</Text>
          <View
              style={{
                marginTop: 4,
                flexDirection: "row",
            ...
            >
              ...
              style={{borderWidth:2,borderColor:"#007FFF",borderRadius:6,padding:10}}
            >
              <Text style={{textAlign:"center",color:"#007FFF",fontWeight:700,fontSize:16}}>SELECT</Text>
